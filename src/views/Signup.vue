...
const signupWithOAuth = async (provider: 'github' | 'google' | 'facebook' | 'linkedin') => {
    ...
    <main class="wrap">
      <section class="shell">
        <aside class="card hero">
          ...
          <div class="subhead">
            Create your account to connect with professionals, share opportunities, and build meaningful relationships.
          </div>
        ...
        <section class="card login">
          <div class="topbar">
            <div class="brand" style="margin:0;">
              ...
              <div>
                ...
                <p style="margin:2px 0 0;">Create your account</p>
              </div>
            </div>
          ...
          <p class="hint">Fill in your details to get started with wocon.</p>
          ...
          <form @submit.prevent="signup" autocomplete="on" novalidate>
            ...
            <div class="oauth">
              <button type="button" @click="signupWithOAuth('github')">
              ...
              <button type="button" @click="signupWithOAuth('google')">
