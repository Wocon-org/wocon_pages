...
const LayerIcon = {
  dark: () => `
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      <path d="M21 19.998a10 10 0 0 1-19.95 1.32 10 10 0 0 1 17.2-14.14 10 10 0 0 1 2.75 12.82zM12 3v2M12 19v2M19 12h2M3 12h2M16.17 7.83l1.41 1.41M6.41 17.59l1.41 1.41M16.17 16.17l-1.41 1.41M6.41 6.41l-1.41 1.41" />
    </svg>
  `,
  satellite: () => `
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      <path d="M12 2a10 10 0 0 0-9.95 9.14 10 10 0 0 0 7.08 15.56 10 10 0 0 0 11.74-3.54A10 10 0 0 0 12 2z" />
    </svg>
  `
}
...
<template>
  <header class="top-bar">
    ...
    <nav class="top-bar-actions">
      ...
      >
        <component :is="'div'" v-html="currentLayer === 'dark' ? LayerIcon.satellite() : LayerIcon.dark()" />
      </button>
      ...
      <a
        ...
        aria-label="GitHub"
      >
        <component :is="'div'" v-html="ActionIcons.github()" />
      </a>
