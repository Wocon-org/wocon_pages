...
- ✅ 数据库 profiles 表添加 nickname 字段
- ✅ 更新 handle_new_user 触发器处理昵称
- ✅ 默认路由改为登录页（未登录用户无法访问首页）
- ✅ 更新 GitHub，推送所有更改
...
- ✅ 完成 WoconMap.vue 组件：Leaflet 地图初始化、图层切换、优化交互
- ✅ Home.vue 添加创建菜单（Create Trip、Create Event、Upload Content）
- ✅ Home.vue 搜索页面添加搜索栏
- 🔄 规划地图功能：
  - **主页左侧地图**：显示全球公开行程（is_public=true 的 trips）
